...
**Goal:** Reescrever o README.md do projeto com arquitetura medalhão explicada, estrutura de diretórios em bloco `text`, screenshots dos cases e seção de autor.

**Architecture:** Arquivo único `README.md` na raiz. Abordagem híbrida (portfólio + educacional) seguindo o template aprovado em `docs/superpowers/specs/2026-05-04-readme-rewrite-design.md`.

**Tech Stack:** Markdown, imagens PNG em `assets/dashboard/`

---

## Arquivo Envolvido

- Modify: `README.md` (raiz do projeto) — substituição completa do conteúdo

---

### Task 1: Escrever o README.md completo

**Files:**
- Modify: `README.md`

- [ ] **Step 1: Substituir o conteúdo do README.md pelo conteúdo abaixo**

Escrever o seguinte conteúdo exato em `README.md`:
...
- [ ] **Step 2: Verificar caminhos das imagens**
...
```bash
git add README.md
git commit -m "docs: reescreve README com arquitetura medalhão, estrutura de diretórios e cases"
```

Saída esperada: `1 file changed, N insertions(+), N deletions(-)`
